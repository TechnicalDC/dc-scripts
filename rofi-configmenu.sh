...
options[zathura]="$HOME/.scripts/gendunstrc"
...
options[micro_conf]="$HOME/.config/micro/settings.json"
options[micro_key]="$HOME/.config/micro/bindings.json"
...
options[neomutt_mailcap]="$HOME/.config/neomutt/mailcap"
options[neomutt_setting]="$HOME/.config/neomutt/settings"
options[neomutt_style]="$HOME/.config/neomutt/style"
